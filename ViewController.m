...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            [IGOverlay removeOverlayInView:nil];
        }
            break;
        case 1:
        {
            [IGOverlay showOverlayWithStatus:nil options:self.headerOption];
        }
            break;
        case 2:
        {
            [IGOverlay showOverlayWithStatus:@"哈哈哈哈"];
        }
            break;
        case 3:
        {
            options = options | self.headerOption;
            [IGOverlay showOverlayWithStatus:@"哈哈哈哈" afterDelay:1.0f options:options];
        }
            break;
        case 4:
        {
